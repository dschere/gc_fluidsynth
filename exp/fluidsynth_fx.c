...
void voice_data_handler(void *usrdata, int chan, fluid_real_t* buf, int buflen) {
    int i;
...
int main(int argc, char **argv)
{
    ...
    fluid_synth_set_user_per_channel_fx_func(synth, voice_data_handler, voice_data);

    /* Play a note */
    fluid_synth_noteon(synth, 0, 60, 50);
    fluid_synth_noteon(synth, 1, 65, 50);
