...
//printf("Output buffers = %d, buffer length = %d\n", nout, len);
...
int main(int argc, char **argv)
{
    ...
    n = fluid_settings_setstr(settings, "audio.driver", "alsa");
    if (n != FLUID_OK) {
    ...
    fluid_synth_noteon(synth, 1, 65, 80);
    fluid_synth_noteon(synth, 2, 70, 50);
